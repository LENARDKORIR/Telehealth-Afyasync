      ...
      <div className="mx-auto w-full max-w-5xl p-4 sm:p-6 lg:p-8">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_0.85fr]">
          <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <h2 className="text-xl font-bold text-slate-900">Call first</h2>
            <div className="mt-5 rounded-2xl border border-rose-200 bg-rose-50 p-4 text-sm leading-7 text-rose-900">
              If you have chest pain, trouble breathing, sudden weakness, heavy bleeding, or severe confusion, call emergency services first.
            </div>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-sm">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-rose-700">Emergency guidance</p>
              <p className="mt-2 text-sm leading-7 text-rose-900/80">
                Call first, then message the urgent care team if you still need care coordination after the immediate risk is addressed.
              </p>
            </div>
